        ...
        return (
            <div className="screen-music">
                ...
                <div className="song-image">
                    <img src={'https://img.wynk.in/unsafe/248x248/filters:no_upscale():format(webp)/http://s3.ap-south-1.amazonaws.com/discovery-prod-arsenal/arsenal/artworks/605441e65a5ce51dd851a61a/COLLECTION_12757457174465.png'} alt="song item"></img>
                </div>
